...
string_object // TODO: Remove this shit
    returns [String value]
     @after {$ctx.value = $text;}:
     BOOLEAN | INTEGER | DOUBLE;
...
vector3D_object
    ...
    : '{' x=int_object SEMICOLON y=int_object SEMICOLON z=int_object '}';
...
attack_attribute
    ...
    :'{' attribute SEMICOLON io=int_object '}' {$ctx.value = new AttributeAttack($attribute.value, $io.value);};
