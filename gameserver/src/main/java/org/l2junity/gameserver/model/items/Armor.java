...
public final class Armor extends ItemTemplate {
	...
	public void set(StatsSet set) {
		...
		if ((_bodyPart == ItemTemplate.SLOT_NECK) || ((_bodyPart & ItemTemplate.SLOT_L_EAR) != 0) || ((_bodyPart & ItemTemplate.SLOT_L_FINGER) != 0) || ((_bodyPart & ItemTemplate.SLOT_R_BRACELET) != 0) || ((_bodyPart & ItemTemplate.SLOT_L_BRACELET) != 0)) {
