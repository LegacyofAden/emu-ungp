 ...
 * @author UnAfraid, Nik
 */
public class OnCreatureSkillUsed implements IBaseEvent
{
	...
	public OnCreatureSkillUsed(Creature caster, Creature target, Skill skill, boolean simultaneously)
	{
		_caster = caster;
		_target = target;
		_skill = skill;
	...
	{
		return EventType.ON_CREATURE_SKILL_USED;
	}
}