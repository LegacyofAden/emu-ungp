...
public class WorldManager {
	 ...
	 * @param id world id
	 * @return created world
	 * @throws RuntimeException throws if world with this id already exists
	 */
	 ...
	 * @throws RuntimeException throws if ID equals MAIN_WORLD_ID
	 */
	 ...
	 *
	 * @param ownerObjectId pet owner object id
