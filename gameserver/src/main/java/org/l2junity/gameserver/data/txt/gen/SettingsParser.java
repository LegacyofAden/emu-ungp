...
public class SettingsParser extends Parser {
	...
	public final Identifier_objectContext identifier_object() throws RecognitionException {
		...
		try {
			...
			setState(228);
			_la = _input.LA(1);
			if ( !(_la==T__19 || _la==NONE || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & ((1L << (ORC - 68)) | (1L << (BOW - 68)) | (1L << (DAGGER - 68)) | (1L << (RAPIER - 68)) | (1L << (CROSSBOW - 68)) | (1L << (GLOVES - 68)))) != 0) || ((((_la - 140)) & ~0x3f) == 0 && ((1L << (_la - 140)) & ((1L << (STEEL - 140)) | (1L << (LEATHER - 140)) | (1L << (ORIHARUKON - 140)) | (1L << (NAME - 140)))) != 0)) ) {
	...
	public static final String _serializedATN =
		...
		"\36 \"$&(*,.\60\62\64\668:<>@B\2\5\16\2\26\26\61\61FFeeggllnn}}\u008e"+
		"\u008e\u0092\u0092\u0095\u0095\u00a9\u00a9\3\2\'(\3\2\')\2\u0169\2D\3"+
