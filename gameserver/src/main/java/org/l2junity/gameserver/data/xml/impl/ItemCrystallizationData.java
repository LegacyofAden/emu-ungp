...
public final class ItemCrystallizationData implements IGameXmlReader {
	...
	private void reload() {
		...
		log.info("Loaded: {} crystallizaion templates.", _crystallizationTemplates.size());
		log.info("Loaded: {} pre-defined crystallizable items.", _items.size());
	...
	private void generateCrystallizationData() {
		...
		log.info("Generated {} crystallizable items from templates.", _items.size() - previousCount);
	}
