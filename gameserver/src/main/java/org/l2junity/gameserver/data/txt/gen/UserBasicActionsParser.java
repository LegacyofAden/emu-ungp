...
public class UserBasicActionsParser extends Parser {
	...
	public static class Handler_typeContext extends ParserRuleContext {
		...
		public TerminalNode SIT_STAND() {
			return getToken(UserBasicActionsParser.SIT_STAND, 0);
		}

		public TerminalNode WALK_RUN() {
			return getToken(UserBasicActionsParser.WALK_RUN, 0);
		}

		public TerminalNode ATTACK() {
			return getToken(UserBasicActionsParser.ATTACK, 0);
		}

		public TerminalNode TRADE() {
			return getToken(UserBasicActionsParser.TRADE, 0);
		}

		public TerminalNode CLIENT_ACTION() {
			return getToken(UserBasicActionsParser.CLIENT_ACTION, 0);
		}

		public TerminalNode PRIVATE_STORE() {
			return getToken(UserBasicActionsParser.PRIVATE_STORE, 0);
		}

		public TerminalNode PACKAGE_PRIVATE_STORE() {
			return getToken(UserBasicActionsParser.PACKAGE_PRIVATE_STORE, 0);
		}

		public TerminalNode SOCIAL_ACTION() {
			return getToken(UserBasicActionsParser.SOCIAL_ACTION, 0);
		}

		public TerminalNode PET_ACTION() {
			return getToken(UserBasicActionsParser.PET_ACTION, 0);
		}

		public TerminalNode PET_DEPOSIT() {
			return getToken(UserBasicActionsParser.PET_DEPOSIT, 0);
		}

		public TerminalNode SUMMON_ACTION() {
			return getToken(UserBasicActionsParser.SUMMON_ACTION, 0);
		}

		public TerminalNode SUMMON_DESPAWN() {
			return getToken(UserBasicActionsParser.SUMMON_DESPAWN, 0);
		}

		public TerminalNode PRIVATE_BUY() {
			return getToken(UserBasicActionsParser.PRIVATE_BUY, 0);
		}

		public TerminalNode MAKE_ITEM() {
			return getToken(UserBasicActionsParser.MAKE_ITEM, 0);
		}

		public TerminalNode MAKE_ITEM2() {
			return getToken(UserBasicActionsParser.MAKE_ITEM2, 0);
		}

		public TerminalNode RIDE() {
			return getToken(UserBasicActionsParser.RIDE, 0);
		}

		public TerminalNode TELEPORT_BOOKMARK() {
			return getToken(UserBasicActionsParser.TELEPORT_BOOKMARK, 0);
		}

		public TerminalNode BOT_REPORT() {
			return getToken(UserBasicActionsParser.BOT_REPORT, 0);
		}

		public TerminalNode AIRSHIP_ACTION() {
			return getToken(UserBasicActionsParser.AIRSHIP_ACTION, 0);
		}

		public TerminalNode COUPLE_ACTION() {
			return getToken(UserBasicActionsParser.COUPLE_ACTION, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_handler_type;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterHandler_type(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitHandler_type(this);
		}
	}
	...
	public static class Identifier_objectContext extends ParserRuleContext {
		...
		public TerminalNode DAGGER() {
			return getToken(UserBasicActionsParser.DAGGER, 0);
		}

		public TerminalNode BOW() {
			return getToken(UserBasicActionsParser.BOW, 0);
		}

		public TerminalNode CROSSBOW() {
			return getToken(UserBasicActionsParser.CROSSBOW, 0);
		}

		public TerminalNode RAPIER() {
			return getToken(UserBasicActionsParser.RAPIER, 0);
		}

		public TerminalNode GLOVES() {
			return getToken(UserBasicActionsParser.GLOVES, 0);
		}

		public TerminalNode STEEL() {
			return getToken(UserBasicActionsParser.STEEL, 0);
		}

		public TerminalNode LEATHER() {
			return getToken(UserBasicActionsParser.LEATHER, 0);
		}

		public TerminalNode ORIHARUKON() {
			return getToken(UserBasicActionsParser.ORIHARUKON, 0);
		}

		public TerminalNode NAME() {
			return getToken(UserBasicActionsParser.NAME, 0);
		}

		public TerminalNode NONE() {
			return getToken(UserBasicActionsParser.NONE, 0);
		}

		public TerminalNode ORC() {
			return getToken(UserBasicActionsParser.ORC, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterIdentifier_object(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitIdentifier_object(this);
		}
	}
	...
	public final Identifier_objectContext identifier_object() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(127);
				_la = _input.LA(1);
				if (!(_la == T__8 || _la == NONE || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (ORC - 65)) | (1L << (BOW - 65)) | (1L << (DAGGER - 65)) | (1L << (RAPIER - 65)) | (1L << (CROSSBOW - 65)) | (1L << (GLOVES - 65)) | (1L << (STEEL - 65)))) != 0) || ((((_la - 132)) & ~0x3f) == 0 && ((1L << (_la - 132)) & ((1L << (LEATHER - 132)) | (1L << (ORIHARUKON - 132)) | (1L << (NAME - 132)))) != 0))) {
	...
	public static class Bool_objectContext extends ParserRuleContext {
		...
		public TerminalNode BOOLEAN() {
			return getToken(UserBasicActionsParser.BOOLEAN, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterBool_object(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitBool_object(this);
		}
	}
	...
	public static class Byte_objectContext extends ParserRuleContext {
		...
		public TerminalNode INTEGER() {
			return getToken(UserBasicActionsParser.INTEGER, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterByte_object(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitByte_object(this);
		}
	}
	...
	public static class Int_objectContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterInt_object(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitInt_object(this);
		}
	}
	...
	public static class Long_objectContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterLong_object(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitLong_object(this);
		}
	}
	...
	public static class Double_objectContext extends ParserRuleContext {
		...
		public TerminalNode DOUBLE() {
			return getToken(UserBasicActionsParser.DOUBLE, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterDouble_object(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitDouble_object(this);
		}
	}
	...
	public static class String_objectContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterString_object(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitString_object(this);
		}
	}
	...
	public static class Name_objectContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterName_object(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitName_object(this);
		}
	}
	...
	public static class Category_objectContext extends ParserRuleContext {
		public TerminalNode CATEGORY() {
			return getToken(UserBasicActionsParser.CATEGORY, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterCategory_object(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitCategory_object(this);
		}
	}
	...
	public static class Vector3D_objectContext extends ParserRuleContext {
		...
		public List<TerminalNode> SEMICOLON() {
			return getTokens(UserBasicActionsParser.SEMICOLON);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterVector3D_object(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitVector3D_object(this);
		}
	}
	...
	public static class Empty_listContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterEmpty_list(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitEmpty_list(this);
		}
	}
	...
	public static class Identifier_listContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterIdentifier_list(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitIdentifier_list(this);
		}
	}
	...
	public static class Double_listContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterDouble_list(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitDouble_list(this);
		}
	}
	...
	public static class Base_attribute_attackContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterBase_attribute_attack(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitBase_attribute_attack(this);
		}
	}
	...
	public static class Attack_attributeContext extends ParserRuleContext {
		...
		public TerminalNode SEMICOLON() {
			return getToken(UserBasicActionsParser.SEMICOLON, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterAttack_attribute(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitAttack_attribute(this);
		}
	}
	...
	public static class AttributeContext extends ParserRuleContext {
		...
		public TerminalNode FIRE() {
			return getToken(UserBasicActionsParser.FIRE, 0);
		}

		public TerminalNode WATER() {
			return getToken(UserBasicActionsParser.WATER, 0);
		}

		public TerminalNode EARTH() {
			return getToken(UserBasicActionsParser.EARTH, 0);
		}

		public TerminalNode WIND() {
			return getToken(UserBasicActionsParser.WIND, 0);
		}

		public TerminalNode HOLY() {
			return getToken(UserBasicActionsParser.HOLY, 0);
		}

		public TerminalNode UNHOLY() {
			return getToken(UserBasicActionsParser.UNHOLY, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterAttribute(this);
		}
	...
	public static class Category_listContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).enterCategory_list(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof UserBasicActionsListener)
				((UserBasicActionsListener) listener).exitCategory_list(this);
		}
	}
