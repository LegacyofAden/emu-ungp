...
public interface NpcDatasListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link NpcDatasParser#mp_reward_type}.
	 * @param ctx the parse tree
	 */
	void enterMp_reward_type(NpcDatasParser.Mp_reward_typeContext ctx);
	/**
	 * Exit a parse tree produced by {@link NpcDatasParser#mp_reward_type}.
	 * @param ctx the parse tree
	 */
	void exitMp_reward_type(NpcDatasParser.Mp_reward_typeContext ctx);
	/**
	 * Enter a parse tree produced by {@link NpcDatasParser#mp_reward_affect_type}.
	 * @param ctx the parse tree
	 */
	void enterMp_reward_affect_type(NpcDatasParser.Mp_reward_affect_typeContext ctx);
	/**
	 * Exit a parse tree produced by {@link NpcDatasParser#mp_reward_affect_type}.
	 * @param ctx the parse tree
	 */
	void exitMp_reward_affect_type(NpcDatasParser.Mp_reward_affect_typeContext ctx);
	/**
