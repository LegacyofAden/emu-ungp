 ...
 */
@Slf4j
@StartupComponent(value = "Data", dependency = {SkillData.class, LevelBonusData.class, ZoneManager.class, MinionData.class})
public class NpcData implements IGameXmlReader {
	...
	private int getOrCreateClanId(String clanName) {
		return _clans.computeIfAbsent(clanName.toUpperCase(), k -> _clans.size());
	}
