...
public class MinionList {
	 ...
	 */
	private final List<MonsterInstance> _minionReferences = new CopyOnWriteArrayList<>();
	/**
	 * List containing the cached deleted minions for reuse
	 */
	protected List<MonsterInstance> _reusedMinionReferences = null;
	...
	public void deleteSpawnedMinions() {
		if (!_minionReferences.isEmpty()) {
			for (MonsterInstance minion : _minionReferences) {
				if (minion != null) {
	...
	private final void spawnMinion(int minionId) {
		...
		if (_reusedMinionReferences != null) {
			final MonsterInstance minion = _reusedMinionReferences.stream().filter(m -> (m.getId() == minionId)).findFirst().orElse(null);
			if (minion != null) {
	 ...
	 * @return
	 */
	public static final MonsterInstance spawnMinion(MonsterInstance master, int minionId) {
	...
	protected static final MonsterInstance initializeNpcInstance(MonsterInstance master, MonsterInstance minion) {
