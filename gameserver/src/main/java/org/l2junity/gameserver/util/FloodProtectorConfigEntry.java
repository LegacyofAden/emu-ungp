 ...
 * @author fordfrog
 */
public final class FloodProtectorConfigEntry {
	/**
	...
	/**
	 * Creates new instance of FloodProtectorConfigEntry.
	 *
	 * @param floodProtectorType {@link #FLOOD_PROTECTOR_TYPE}
	 */
	public FloodProtectorConfigEntry(final String floodProtectorType) {
		super();
