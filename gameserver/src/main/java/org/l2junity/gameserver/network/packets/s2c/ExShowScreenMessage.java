...
public class ExShowScreenMessage extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.EX_SHOW_SCREEN_MESSAGE.writeId(body);

		body.writeD(_type);
		body.writeD(_sysMessageId);
		body.writeD(_position);
		body.writeD(_unk1);
		body.writeD(_size);
		body.writeD(_unk2);
		body.writeD(_unk3);
		body.writeD(_effect ? 0x01 : 0x00);
		body.writeD(_time);
		body.writeD(_fade ? 0x01 : 0x00);
