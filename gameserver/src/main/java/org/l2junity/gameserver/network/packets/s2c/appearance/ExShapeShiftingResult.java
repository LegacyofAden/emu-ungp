 ...
 * @author UnAfraid
 */
public class ExShapeShiftingResult extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.EX_SHAPE_SHIFTING_RESULT.writeId(body);

		body.writeD(_result);
		body.writeD(_targetItemId);
		body.writeD(_extractItemId);
	}
}
