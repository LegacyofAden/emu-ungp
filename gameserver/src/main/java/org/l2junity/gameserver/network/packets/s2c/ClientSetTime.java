...
public final class ClientSetTime extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.CLIENT_SET_TIME.writeId(body);

		body.writeD(_timeInMinutesOfDay);
		body.writeD(DateTimeConfig.TIME_MULTIPLIER);
	}
}