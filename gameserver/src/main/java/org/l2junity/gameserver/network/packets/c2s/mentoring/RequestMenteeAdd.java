...
import org.l2junity.gameserver.network.packets.s2c.mentoring.ExMentorAdd;
 ...
 */
public class RequestMenteeAdd extends GameClientPacket {
	...
	@Override
	public void runImpl() {
		final Player mentor = getClient().getActiveChar();
		if (mentor == null) {
			return;
		}
