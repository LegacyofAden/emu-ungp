 ...
 * @author UnAfraid
 */
public class ExAlterSkillRequest extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.EX_ALTER_SKILL_REQUEST.writeId(body);
		body.writeD(_nextSkillId);
		body.writeD(_currentSkillId);
		body.writeD(_alterTime);
	}
}
