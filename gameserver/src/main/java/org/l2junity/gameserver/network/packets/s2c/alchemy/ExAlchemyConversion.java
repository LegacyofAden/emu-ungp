 ...
 * @author Sdw
 */
public class ExAlchemyConversion extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.EX_ALCHEMY_CONVERSION.writeId(body);

		body.writeC(0x00); // TODO: Find me
		body.writeD(_successCount);
		body.writeD(_failureCount);
	}
}
