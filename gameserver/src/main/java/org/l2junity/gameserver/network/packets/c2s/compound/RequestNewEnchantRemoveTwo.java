 ...
 * @author UnAfraid
 */
public class RequestNewEnchantRemoveTwo extends GameClientPacket {
	...
	public void runImpl() {
		...
		if ((request == null) || request.isProcessing()) {
			getClient().sendPacket(ExEnchantTwoRemoveFail.STATIC_PACKET);
			return;
		}
		...
		getClient().sendPacket(ExEnchantTwoRemoveOK.STATIC_PACKET);
	}
}