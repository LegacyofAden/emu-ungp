 ...
 * @author NosBit
 */
public class ExResponseCommissionInfo extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.EX_RESPONSE_COMMISSION_INFO.writeId(body);

		body.writeD(_result);
		body.writeD(_itemId);
		body.writeQ(_presetPricePerUnit);
		body.writeQ(_presetAmount);
		body.writeD(_presetDurationType);
	}
}
