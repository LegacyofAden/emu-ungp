 ...
 * @author UnAfraid
 */
public class ExCastleState extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.EX_CASTLE_STATE.writeId(body);

		body.writeD(_castleId);
		body.writeD(_castleSide.ordinal());
	}
}
