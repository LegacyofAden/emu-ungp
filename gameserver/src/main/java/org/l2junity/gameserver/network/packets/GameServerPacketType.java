...
public enum GameServerPacketType {
	...
	GameServerPacketType(int id1) {
		this(id1, -1);
	}

	GameServerPacketType(int id1, int id2) {
		_id1 = id1;
		_id2 = id2;
	}
	...
	public void writeId(PacketBody packet) {
		packet.writeC(_id1);
		if (_id2 > 0) {
			packet.writeH(_id2);
		}
	...
	public static GameServerPacketType getPacket(int id1, int id2) {
		for (GameServerPacketType packet : values()) {
