...
import org.l2junity.gameserver.network.packets.s2c.friend.FriendAddRequestResult;
	...
	public void runImpl() {
		...
		if (_response == 1) {
			...
			try (Connection con = DatabaseFactory.getInstance().getConnection();
				...
				log.error("Could not add friend objectid: " + e.getMessage(), e);
			}
		} else {
