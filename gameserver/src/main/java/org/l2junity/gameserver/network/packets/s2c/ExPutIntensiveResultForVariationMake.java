...
public class ExPutIntensiveResultForVariationMake extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.EX_PUT_INTENSIVE_RESULT_FOR_VARIATION_MAKE.writeId(body);

		body.writeD(_refinerItemObjId);
		body.writeD(_lifestoneItemId);
		body.writeD(_gemstoneItemId);
		body.writeQ(_gemstoneCount);
		body.writeD(_unk2);
	}
}