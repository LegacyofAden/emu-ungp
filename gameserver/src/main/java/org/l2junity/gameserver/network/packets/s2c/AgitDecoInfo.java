...
public class AgitDecoInfo extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.AGIT_DECO_INFO.writeId(body);
		body.writeD(_residense.getResidenceId());
		for (ResidenceFunctionType type : ResidenceFunctionType.values()) {
			if (type == ResidenceFunctionType.NONE) {
				continue;
			}
			body.writeC(_residense.hasFunction(type) ? 0x01 : 0x00);
		}

		// Unknown
		body.writeD(0); // TODO: Find me!
		body.writeD(0); // TODO: Find me!
		body.writeD(0); // TODO: Find me!
		body.writeD(0); // TODO: Find me!
		body.writeD(0); // TODO: Find me!
