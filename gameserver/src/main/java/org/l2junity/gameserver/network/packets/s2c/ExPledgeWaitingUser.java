 ...
 * @author Sdw
 */
public class ExPledgeWaitingUser extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.EX_PLEDGE_WAITING_USER.writeId(body);

		body.writeD(_pledgeRecruitInfo.getPlayerId());
		body.writeS(_pledgeRecruitInfo.getMessage());
	}
}