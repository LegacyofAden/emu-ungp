 ...
 * @author Sdw
 */
public class ExConnectedTimeAndGettableReward extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.EX_CONNECTED_TIME_AND_GETTABLE_REWARD.writeId(body);
		body.writeD(0x00);
		body.writeD(_oneDayRewardAvailableCount);
		body.writeD(0x00);
		body.writeD(0x00);
		body.writeD(0x00);
		body.writeD(0x00);
