...
public class ExStorageMaxCount extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.EX_STORAGE_MAX_COUNT.writeId(body);

		body.writeD(_inventory);
		body.writeD(_warehouse);
		body.writeD(_freight);
		body.writeD(_clan);
		body.writeD(_privateSell);
		body.writeD(_privateBuy);
		body.writeD(_receipeD);
		body.writeD(_recipe);
		body.writeD(_inventoryExtraSlots); // Belt inventory slots increase count
		body.writeD(_inventoryQuestItems);
		body.writeD(40); // TODO: Find me!
		body.writeD(40); // TODO: Find me!
	}
}