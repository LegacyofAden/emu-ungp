...
public class CharSelectionInfo implements IClientOutgoingPacket {
	...
	public boolean write(PacketWriter packet) {
		...
		packet.writeD(GameserverConfig.MAX_CHARACTERS_NUMBER_PER_ACCOUNT);
		packet.writeC(size == GameserverConfig.MAX_CHARACTERS_NUMBER_PER_ACCOUNT ? 0x01 : 0x00); // if 1 can't create new char
