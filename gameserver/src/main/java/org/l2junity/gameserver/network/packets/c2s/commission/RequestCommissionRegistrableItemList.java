 ...
 * @author NosBit
 */
public class RequestCommissionRegistrableItemList extends GameClientPacket {
	@Override
	...
	public void runImpl() {
		...
		getClient().sendPacket(new ExResponseCommissionItemList(player.getInventory().getAvailableItems(false, false, false)));
	}
}
