 ...
 * @author NosBit
 */
public class RequestCommissionInfo extends GameClientPacket {
	...
	public void runImpl() {
		...
		if (itemInstance != null) {
			getClient().sendPacket(player.getLastCommissionInfos().getOrDefault(itemInstance.getId(), ExResponseCommissionInfo.EMPTY));
		} else {
			getClient().sendPacket(ExResponseCommissionInfo.EMPTY);
		}
	}
}
