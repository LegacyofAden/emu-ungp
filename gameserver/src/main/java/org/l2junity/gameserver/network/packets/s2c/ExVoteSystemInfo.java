...
public class ExVoteSystemInfo extends GameServerPacket {
	...
	protected void writeImpl(PacketBody body) {
		GameServerPacketType.EX_VOTE_SYSTEM_INFO.writeId(body);

		body.writeD(_recomLeft);
		body.writeD(_recomHave);
		body.writeD(_bonusTime);
		body.writeD(_bonusVal);
		body.writeD(_bonusType);
	}
}