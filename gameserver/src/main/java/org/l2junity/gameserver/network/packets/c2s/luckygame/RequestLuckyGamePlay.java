 ...
 */
package org.l2junity.gameserver.network.packets.c2s.luckygame;
...
import org.l2junity.gameserver.network.packets.s2c.luckygame.ExBettingLuckyGameResult;
 ...
 * @author Sdw
 */
public class RequestLuckyGamePlay extends GameClientPacket {
	private LuckyGameType _type;
	private int _reading;

	@Override
	public void readImpl() {
		final int type = CommonUtil.constrain(readD(), 0, LuckyGameType.values().length);
		_type = LuckyGameType.values()[type];
		_reading = CommonUtil.constrain(readD(), 0, 50); // max play is 50
