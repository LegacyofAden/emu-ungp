...
import org.l2junity.gameserver.network.packets.s2c.PrivateStoreMsgSell;
...
public class SetPrivateStoreListSell extends GameClientPacket {
	...
	public void readImpl() {
		...
		int count = readD();
		if ((count < 1) || (count > PlayerConfig.MAX_ITEM_IN_PACKET) || ((count * BATCH_LENGTH) != getAvailableBytes())) {
			return;
		}
