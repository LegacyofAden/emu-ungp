	...
	public String onAdvEvent(String event, Npc npc, PlayerInstance player) {
		...
		switch (event) {
			...
			case "turncard5": {
				...
				if ((i9 % 32) < 31) {
					htmltext = getHtm(player.getLang(), "30845-12.html");
				} else if ((i9 % 32) == 31) {
					int i6 = 0;
					int i8 = 0;
					...
					if (i6 == 40) {
						...
						st.set("ex", 0);
						st.setCond(0);
						htmltext = getHtm(player.getLang(), "30845-13.html");
					} else if (i6 == 30) {
						giveItems(player, 959, 2);
						giveItems(player, 951, 2);
						st.set("ex", 0);
						st.setCond(0);
						htmltext = getHtm(player.getLang(), "30845-14.html");
					} else if ((i6 == 21) || (i6 == 12)) {
						giveItems(player, 729, 1);
						...
						st.set("ex", 0);
						st.setCond(0);
						htmltext = getHtm(player.getLang(), "30845-15.html");
					} else if (i6 == 20) {
						giveItems(player, 951, 2);
						st.set("ex", 0);
						st.setCond(0);
						htmltext = getHtm(player.getLang(), "30845-16.html");
					} else if (i6 == 11) {
						giveItems(player, 951, 1);
						st.set("ex", 0);
						st.setCond(0);
						htmltext = getHtm(player.getLang(), "30845-17.html");
					} else if (i6 == 10) {
						giveItems(player, 956, 2);
						st.set("ex", 0);
						st.setCond(0);
						htmltext = getHtm(player.getLang(), "30845-18.html");
					} else if (i6 == 0) {
						st.set("ex", 0);
						st.setCond(0);
						htmltext = getHtm(player.getLang(), "30845-19.html");
					}
				}
		...
		switch (st.getState()) {
			...
			case State.STARTED: {
				if (st.isCond(0)) {
					...
					htmltext = getHtm(player.getLang(), "30845-11a.html");
