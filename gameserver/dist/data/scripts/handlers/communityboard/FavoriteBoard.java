...
public class FavoriteBoard implements IParseBoardHandler {
	...
	public boolean parseCommunityBoardCommand(String command, PlayerInstance activeChar) {
		...
		if (command.startsWith("_bbsgetfav")) {
			// Load Favorite links
			final String list = HtmRepository.getInstance().getCustomHtm("CommunityBoard/favorite_list.html");
			...
			try (Connection con = DatabaseFactory.getInstance().getConnection();
				...
				String html = HtmRepository.getInstance().getCustomHtm("CommunityBoard/favorite.html");
