		...
		switch (cmd) {
			...
			case "admin_announces": {
				...
				switch (subCmd) {
					case "add": {
						if (!st.hasMoreTokens()) {
							String content = HtmRepository.getInstance().getCustomHtm("admin/announces-add.htm");
					...
					case "edit": {
						...
						if (!st.hasMoreTokens()) {
							String content = HtmRepository.getInstance().getCustomHtm("admin/announces-edit.htm");
					...
					case "show": {
						...
						final IAnnouncement announce = AnnouncementsTable.getInstance().getAnnounce(id);
						if (announce != null) {
							String content = HtmRepository.getInstance().getCustomHtm("admin/announces-show.htm");
							String announcementId = "" + announce.getId();
							String announcementType = announce.getType().name();
							String announcementInital = "0";
							String announcementDelay = "0";
					...
					case "list": {
						...
						String content = HtmRepository.getInstance().getCustomHtm("admin/announces-list.htm");
