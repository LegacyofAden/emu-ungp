	...
	public boolean useAdminCommand(String command, Player activeChar) {
		...
		switch (cmd) {
			case "admin_punishment": {
				if (!st.hasMoreTokens()) {
					String content = HtmRepository.getInstance().getCustomHtm("admin/punishment.htm");
					if (content != null) {
					...
					switch (subcmd) {
						case "info": {
							...
							String content = HtmRepository.getInstance().getCustomHtm("admin/punishment-info.htm");
							if (content != null) {
						...
						case "player": {
							...
							String content = HtmRepository.getInstance().getCustomHtm("admin/punishment-player.htm");
							if (content != null) {
