...
public final class Raina extends AbstractNpcAI {
...

	{
		...
		classCloak.put(CategoryType.SIXTH_IS_GROUP, 30315); // Naviarope Cloak Grade
		classCloak.put(CategoryType.SIXTH_WYNN_GROUP, 30316); // Leister Cloak Grade
...

	{
		...
		powerItem.put(CategoryType.SIXTH_IS_GROUP, 32269); // Naviarope Power
		powerItem.put(CategoryType.SIXTH_WYNN_GROUP, 32270); // Leister Power
	...
	public final List<ClassId> getAvailableDualclasses(Player player) {
