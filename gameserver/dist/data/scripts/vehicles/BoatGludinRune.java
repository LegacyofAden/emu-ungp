		...
		try {
			switch (_cycle) {
				case 0:
					...
					ThreadPool.getInstance().scheduleGeneral(this, 240000, TimeUnit.MILLISECONDS);
					break;
				case 1:
					BoatManager.getInstance().broadcastPacket(GLUDIN_DOCK[0], RUNE_DOCK[0], LEAVE_GLUDIN1);
					ThreadPool.getInstance().scheduleGeneral(this, 40000, TimeUnit.MILLISECONDS);
					break;
				case 2:
					BoatManager.getInstance().broadcastPacket(GLUDIN_DOCK[0], RUNE_DOCK[0], LEAVE_GLUDIN0);
					ThreadPool.getInstance().scheduleGeneral(this, 20000, TimeUnit.MILLISECONDS);
					break;
				case 3:
					...
					ThreadPool.getInstance().scheduleGeneral(this, 250000, TimeUnit.MILLISECONDS);
					break;
				case 4:
					BoatManager.getInstance().broadcastPacket(RUNE_DOCK[0], GLUDIN_DOCK[0], ARRIVAL_RUNE15);
					ThreadPool.getInstance().scheduleGeneral(this, 300000, TimeUnit.MILLISECONDS);
					break;
				case 5:
				...
				case 8:
					if (BoatManager.getInstance().dockBusy(BoatManager.RUNE_HARBOR)) {
						...
						ThreadPool.getInstance().scheduleGeneral(this, 5000, TimeUnit.MILLISECONDS);
						return;
					}
				...
				case 13:
					...
					ThreadPool.getInstance().scheduleGeneral(this, 60000, TimeUnit.MILLISECONDS);
					break;
				case 14:
