...
public class ListenerTest extends AbstractNpcAI
{
	...
	private ListenerTest()
	{
		...
		{
			_log.info(event.getActiveChar() + " OnPlayerDlgAnswer: Answer: " + event.getAnswer() + " MessageId: " + event.getMessageId());
		}, this));
	}
	...
	{
		_log.info(event.getClass().getSimpleName() + " invoked attacker: " + event.getAttacker() + " target: " + event.getTarget() + " damage: " + event.getDamage() + " skill: " + event.getSkill());
	}
	...
	{
		_log.info(event.getClass().getSimpleName() + " invoked attacker: " + event.getAttacker() + " target: " + event.getTarget());
	}
	...
	{
		_log.info("The siege of " + event.getSiege().getCastle().getName() + " (" + event.getSiege().getCastle().getResidenceId() + ") has started!");
	}
	...
	{
		_log.info("Item [" + event.getItem() + "] has been created actor: " + event.getActiveChar() + " process: " + event.getProcess() + " reference: " + event.getReference());
	}
	...
	{
		_log.info("Skill [" + event.getSkill() + "] has been used actor: " + event.getCaster() + " target: " + event.getTarget() + " isSimultaneously: " + event.isSimultaneously());
	}
	...
	{
		_log.info("Player: " + event.getActiveChar() + " has logged in!");
	}
	...
	private TerminateReturn onPlayerDeath(OnCreatureDeath event)
	{
		...
		{
			_log.info("Player: " + event.getTarget() + " was prevented from dying!");
