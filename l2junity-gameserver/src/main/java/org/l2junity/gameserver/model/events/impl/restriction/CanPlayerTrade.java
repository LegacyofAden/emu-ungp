 ...
 * @author lord_rex
 */
public final class CanPlayerTrade implements IBaseEvent
{
	private final PlayerInstance _requestor;
	private final PlayerInstance _target;
	
	public CanPlayerTrade(PlayerInstance requestor, PlayerInstance target)
	{
	...
	{
		return EventType.CAN_PLAYER_TRADE;
	}
}
