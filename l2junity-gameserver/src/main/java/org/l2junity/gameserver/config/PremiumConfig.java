 ...
 * @author Sdw
 */
@ConfigClass(fileName = "Premium")
public class PremiumConfig extends ConfigPropertiesLoader
{
	@ConfigField(name = "RatePremiumXp", value = "1.0", comment =
	{
	...
	@ConfigField(name = "RatePremiumSp", value = "1.0", comment =
	{
