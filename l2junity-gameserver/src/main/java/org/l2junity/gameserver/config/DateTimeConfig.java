 ...
 * @author _dev_
 */
@ConfigClass(fileName = "Datetime")
public final class DateTimeConfig extends ConfigPropertiesLoader
{
	@ConfigField(name = "SaveTime", value = "false", comment =
	{
		"Whether to store datetime in the database."
	})
	public static boolean SAVE_TIME;
	
	@ConfigField(name = "TimeMultiplier", value = "6", comment =
	{
