 ...
 * @author lord_rex
 */
public final class LoginConfigGenerator extends AbstractConfigGenerator
{
	@Override
	protected String getPackageName()
	{
		return LoginConfigMarker.class.getPackage().getName();
	}
	
	public static void main(String[] args)
	{
		AppInit.MODE = ApplicationMode.LOGIN;
		new LoginConfigGenerator();
	}
}
