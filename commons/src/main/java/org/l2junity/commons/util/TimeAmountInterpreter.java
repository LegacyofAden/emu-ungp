...
public class TimeAmountInterpreter
{
	 ...
	 */
	public static final String consolidateNanos(long timeAmountInNanos)
	{
	 ...
	 * @return an user-friendly description of the given time amount
	 */
	public static final String consolidateMillis(long timeAmountInMillis)
	{
	 ...
	 * @return an user-friendly description of the given time amount
	 */
	public static final String consolidate(long timeAmount, TimeUnit timeUnit)
	{
	 ...
	 * @return an user-friendly description of the given time amount
	 */
	public static final String consolidate(long timeAmount, TimeUnit timeUnit, TimeUnit minConsolidationUnit, TimeUnit maxConsolidationUnit, String noTimeUsedIndicator)
	{
	...
	public static final <T extends Appendable & CharSequence> T appendConsolidated(T textBuilder, long timeAmount, TimeUnit timeUnit, TimeUnit minConsolidationUnit, TimeUnit maxConsolidationUnit, String noTimeUsedIndicator) throws RuntimeException
	{
		try
		{
			if (timeAmount < 1)
